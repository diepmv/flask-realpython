...
class AllTest(unittest.TestCase):
  ...
  def test_user_setup(self):
    new_user = User('michael', 'michael@gmail.com', 'michaelherman')
  ...
  def create_task(self):
    return self.app.post('add/', data=dict(name='Go to the Bank', due_date='10/08/2016', priority='1', posted_date='10/08/2016', status='1'), follow_redirects=True)
...
######
  ...
  def test_user_can_add_tasks(self):
    self.create_user('Michael', 'michael@gmail.com', 'python')
  ...
  def test_users_cannot_add_tasks_when_error(self):
    ...
    self.login('Michael', 'python')
    self.app.get('tasks/', follow_redirects=True)
    response = self.app.post('add/', data=dict(name='Go to the bank', due_date='', priority='1', posted_date='02/05/2014', status='1'), follow_redirects=True)
  ...
  def test_users_cannot_complete_tasks_that_are_not_created_by_them(self):
    ...
    self.create_task()
    self.logout()
    self.create_user('Fletcher', 'fletcher@gmail.com', 'python101')
    self.login('Fletcher', 'python101')
    self.app.get('tasks/', follow_redirects=True)
    response = self.app.get("complete/1/", follow_redirects=True)
